...
Compétences Techniques
      ...
      Langages
      Rust, C++, C, Python, HTML/CSS, SQL
    
    
      Outils CAO/Simulation
      CATIA, Onshape, Ansys, OpenVSP, Cameo
      ...
      Fabrication
      Composites, usinage, modélisation 3D
    
    
      Langues
      Français (natif), Anglais (B2 – IELTS 6.0)
...
Formation
      ...
      Prépa Joffre (Montpellier, France)
      Classe préparatoire PC (Physique-Chimie)
      2020–2023
...
Modélisation computationnelle, CFD, programmation pour l’aérospatial (Cranfield)
Programmation, conception, modélisation (ESTIA)

Expérience professionnelle
Stages et projets techniques
...
Expérience
      ...
      ESTIA
      Stage : Fabrication de peau composite
      Août–Sept 2025
      Méthodologie, outillage et découpe pour une fusée expérimentale.
    
    
      Compositadour
      Stage : Fabrication de tubes composites
      Août–Sept 2025
      Expérience en fabrication avancée de composites.
    
    
      432 Technologies
      Stage : Développement logiciel
      Fév–Mar 2024
      Contribution à la bibliothèque open-source "Dessin" et intégration de données collaboratives (AIS/ADS-B).
    
    
      ESTIA Système
      Coupe de France de Robotique
      Avr 2024
      Modélisation d’une base rotative pour robot.
    
    
      ESTIA Aero
      Projet FUSEX (NAASC)
      Fév–Avr 2025
      Fabrication de la peau composite et des systèmes de télémétrie.
    
    
      Dassault UAV Challenge
      Analyse des besoins
      Sep–Déc 2023
      Définition des parties prenantes et matrice de conformité.
...
Restaurant Leclère (Montpellier) : Préparation d’entrées et dressage d’assiettes (Fév 2019).
...
Projets
      ...
      Bibliothèque "Dessin"
      Exemples d’utilisation et optimisation pour l’export SVG/PDF.
    
    
      Bibliothèque "Palette"
      Développement d’une bibliothèque de gestion des couleurs.
      ...
      FUSEX (NAASC)
      Fabrication et intégration de systèmes pour une fusée expérimentale.
